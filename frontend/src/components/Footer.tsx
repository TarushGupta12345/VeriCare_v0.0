    ...
    <footer className="bg-blue-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">VeriCare</span>
            </div>
            <p className="text-blue-200 mb-4">
              Making healthcare billing fair and transparent for everyone.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:vericareai@gmail.com" className="text-blue-200 hover:text-white transition-colors">vericareai@gmail.com</a>
              </li>
              <li className="flex items-center">
                <MapPin className="h-5 w-5 text-blue-300 mr-2" />
                <span className="text-blue-200">San Jose, CA</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-blue-800 text-center text-blue-300 text-sm">
          <p>&copy; {new Date().getFullYear()} VeriCare. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
